...
length_of_boundary = 10
width_of_boundary = 12  # in meter
depth_of_boundary = 60  # in meter
number_of_cells_x = 10
number_of_cells_y = 12
number_of_cells_z = 60

number_of_layers = 1 # in the meantime, keep it as 1 for simplicity

stiffness_mean = [1e7]  # Pa 
COV =0.15    # for making random field
